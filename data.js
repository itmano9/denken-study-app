...
■ 電磁誘導とファラデーの法則
コイルを貫く磁束$\\Phi$〔Wb〕が時間とともに変化すると、コイルに起電力が発生する(電磁誘導)。巻数$N$のコイルに生じる起電力の大きさ$e$〔V〕は
  $e = N\\dfrac{\\varDelta \\Phi}{\\varDelta t}$
で表される(レンツの法則より、この起電力は磁束の変化を妨げる向きに生じる)。

■ 自己インダクタンス
コイルに電流$I$〔A〕を流したときに生じる磁束を$\\Phi$〔Wb〕とすると、自己インダクタンス$L$〔H〕は
  $L = \\dfrac{N\\Phi}{I}$
で定義される。環状鉄心にコイルを巻いた場合、自己インダクタンスは巻数の2乗に比例する($L \\propto N^2$)。これは、電流が同じでも巻数が$N$倍になると磁束も$N$倍になり、鎖交磁束数$N\\Phi$はさらに$N$倍されるためである。
